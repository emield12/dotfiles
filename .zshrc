...
plugins=(
    ...
    history # history search with h / hs[searchterm] 
    jsontools   # pp_json: pretty prints json.
                # is_json: returns true if valid json; false otherwise.
                # urlencode_json: returns a url encoded string for the given json.
                # urldecode_json: returns decoded json for the given url encoded string.
    zsh-syntax-highlighting # Just makes it nicer :D
    python
    docker
    )
...
zstyle :compinstall filename '/home/emield/.zshrc'
...
export FZF_DEFAULT_OPTS="--bind 'ctrl-d:reload(fd . --type d -H -E .git),ctrl-r:reload($FZF_DEFAULT_COMMAND),ctrl-i:reload(fd --type f -HI -E .git)'"

export FZF_CTRL_T_COMMAND="$FZF_DEFAULT_COMMAND"
export FZF_ALT_C_COMMAND='fd --type d -H -E .git'
    # fzf --bind 'ctrl-d:reload(fd --type d -H -E .git)'
